...
BASE = Path("/private/groups/colquittlab/song-system-grn/snrna/integration/datasets/samap_bf-adult_gg-adult")
LM = Path("/private/groups/colquittlab/song-system-grn/snrna/integration/datasets/snrna-bf-adult_snrna-gg-adult/data")
GG = Path("/private/groups/colquittlab/song-system-grn/snrna/integration/datasets/snrna-bf-adult_snrna-gg-adult/data")
...
def main(out_dir: Path, numiters: int, ncpus: int, seed: int, finch_h5ad: str):
    ...
    sams = {
        ...
        "gg": load_sam(GG / "gg_adult.h5ad", "cluster", "chicken", True),
    }
...
if __name__ == "__main__":
    ...
    p.add_argument("--finch_h5ad", type=str, default=str(LM / "bf_adult.h5ad"))
