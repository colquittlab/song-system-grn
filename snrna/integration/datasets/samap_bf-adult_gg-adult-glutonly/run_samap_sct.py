...
SCT_DIR = Path("/private/groups/colquittlab/song-system-grn/snrna/integration/composite_scoring/data/seurat_sct_samap")
...
if __name__ == "__main__":
    ...
    p.add_argument("--out_dir", type=Path, default=BASE / "results_SCT")
