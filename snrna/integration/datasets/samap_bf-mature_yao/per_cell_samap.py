...
if __name__ == "__main__":
    ...
    p.add_argument("--ref_species", default="mm")
    p.add_argument("--query_h5ad", type=Path,
                   default=Path("/private/groups/colquittlab/saturn/snrna-bf-dev_snrna-lamanno-dev/data/bf_dev_v3_mature.h5ad"))
    p.add_argument("--native_umap_key", default="X_umap_rna40_atac30")
